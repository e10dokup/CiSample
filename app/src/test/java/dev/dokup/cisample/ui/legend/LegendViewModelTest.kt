...
class LegendViewModelTest {
    @Test
    fun uiState_initiallyLoading() = runTest {
        val viewModel = LegendViewModel(FakeLegendRepository())
        assertEquals(viewModel.uiState.first(), LegendUiState.Loading)
    }
...
private class FakeLegendRepository : LegendRepository {
